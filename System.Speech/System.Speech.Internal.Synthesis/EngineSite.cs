...
namespace System.Speech.Internal.Synthesis
{
	internal class EngineSite : ITtsEngineSite, ITtsEventSink
	{
		...
		private TTSEvent CreateTtsEvent(SpeechEventInfo sapiEvent)
		{
			...
			{
			case 6:
				return TTSEvent.CreatePhonemeEvent(((char)((uint)(int)sapiEvent.Param2 & 0xFFFFu)).ToString() ?? "", ((char)((uint)sapiEvent.Param1 & 0xFFFFu)).ToString() ?? "", TimeSpan.FromMilliseconds(sapiEvent.Param1 >> 16), (SynthesizerEmphasis)((uint)(int)sapiEvent.Param2 >> 16), _prompt, _audio.Duration);
			case 4:
			{
